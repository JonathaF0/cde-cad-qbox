...
function API.CreateCivilian(civilianData, callback)
    ...
    local payload = {
        ...
        ssn = civilianData.ssn or civilianData.citizenid,
        communityId = Config.COMMUNITY_ID,
        discordId = civilianData.discordId,  -- Link to CAD account
        -- Optional fields
...
function API.UpdateCivilian(civilianId, updateData, callback)
    ...
    -- Add communityId to the update data
...
-- Get civilian by SSN/CitizenID (for FiveM lookups)
...
function API.DeleteCivilian(citizenid, callback)
    Utils.Debug('Deleting civilian:', citizenid)
    QueueRequest('DELETE', '/civilian/fivem-delete-character/' .. citizenid .. '?communityId=' .. Config.COMMUNITY_ID, nil, callback)
end
...
function API.RegisterVehicle(vehicleData, callback)
    ...
    local payload = {
        ...
        ownerId = vehicleData.ownerId, -- CAD civilian ID or citizenid
        communityId = Config.COMMUNITY_ID,
